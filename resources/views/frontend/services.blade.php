...
@section('main-container')
    ...
    <div class="site-section1 pt-5">
        ...
        <div class="container"id="toilet-terrace">
            <div class="row justify-content-center my-5">
                <div class="col-md-7 text-center">
                    <span class="text-serif text-primary">Waterproofing</span>
        ...
        <div class="container" style="background: whitesmoke " id="industrial-RCC">
            <div class="row justify-content-center mt-5">
                <div class="col-md-7 text-center">
                    <span class="text-serif text-primary">Waterproofing</span>
                    <h3 class="heading-92913 text-black text-center"> Industrial RCC Containers Services . . .</h3>
                </div>

                <p> Explore cutting-edge solutions for industrial needs with Dhruvin Creation and Waterproofing.
                    Our expertise in Industrial RCC Containers ensures the strength, durability, and reliability required
                    for diverse
                    industrial applications. Trust us to deliver excellence in the creation and maintenance of robust
                    containers that
                    meet your specific requirements.</p>
                <div class="py-5">
                    <div class="container">
                        <div class="row">
                            <h4 class="heading-92913 text-dark">Our Industrial RCC Containers Services :</h4>
                            <p>At Dhruvi Creation and Waterproofing, we specialize in providing comprehensive services for
                                Industrial RCC
                            ...
                            <div class="col-md-4 service-29283">
                                ...
                                <p> Collaborate with our expert team to design and construct customized RCC
                                    containers tailored to your industrial needs</p>
                            </div>
                            <div class="col-md-4 service-29283">
                                <span class="wrap-icon-39293">
                                ...
                                <p> Ensure the structural integrity of containers with high-quality reinforced concrete,
                                    providing durability and long-term reliability</p>
                            </div>
                            <div class="service-29283 col-md-4">
                                <span class="wrap-icon-39293">
                                ...
                                <p> Benefit from our ongoing maintenance and repair services, enhancing the lifespan
                                    and performance of your industrial containers </p>
                            </div>

                        </div>
                        <h4 class="heading-92913 text-dark my-5">Key Features of Our Industrial RCC Containers:</h4>
                        <div class="row">
                            ...
                            <div class="col-md-4 service-29283">
                                ...
                                <h3>Customization :</h3>
                                <p>Tailored solutions that match the specific dimensions, capacity, and requirements of your
                            ...
                            <div class="col-md-4 service-29283">
                                ...
                                <p>Reinforced Concrete: Utilize the strength of reinforced concrete for containers that can
        ...
        <div class="container" style="background: whitesmoke" id="expansion-joint">
            <div class="row justify-content-center mt-5">
                <div class="col-md-7 text-center">
                    <span class="text-serif text-primary">Waterproofing</span>
                    <h3 class="heading-92913 text-black text-center"> Expansion Joint & Sealant Work, etc. Services . . .
                    </h3>
                </div>

                <p> Welcome to Dhruvi Creation and Waterproofing, your trusted partner for specialized solutions in
                    expansion joint and sealant work, among other services. Our commitment to excellence ensures the
                    integrity
                    and longevity of structures through precise treatments and high-quality materials. Explore our
                    comprehensive
                    range of services tailored to meet your specific needs</p>

                <div class="py-5">
                    <div class="container">
                        <h4 class="heading-92913 text-dark text-center">Our Specialized Services :</h4>
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="row mt-4">
                                    <div class="col-md-6 service-29283">
                                        <h3>Joint Sealing :</h3>
                                        <p>Utilize advanced sealing techniques to protect construction joints from water
                                            ingress,
                                            preventing potential damage.</p>
                                    ...
                                    <div class="col-md-6 service-29283 ">
                                        <h3>Flexible Joint Fillers :</h3>
                                        <p>Implement flexible joint fillers to accommodate structural movement, reducing the
                                            risk of
                                            cracks and maintaining the integrity of joints.</p>
                                        <span class="wrap-icon-39293 mt-5">
                            ...
                            <div class="col-md-6">
                                <div class="row mt-4">
                                    ...
                                    <div class="col-md-6 service-29283 ">
                                        ...
                                        <p>Enhance the appearance of structures with sealant work that not only that protects but 
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-6">
                                <div class="row mt-4">
                                    ...
                                    <div class="col-md-6 service-29283 ">
                                        <h3>Innovation :</h3>
                                        <p> Embrace the innovative solutions leveraging the latest technologies in the expansion joint and the sealant 
                                            treatments.
                                            </p>
                                        <span class="wrap-icon-39293 mt-5">
        ...
        <div class="container" id="epoxy-grouting">
            <div class="row justify-content-center mt-5">
                <div class="col-md-7 text-center">
                    <span class="text-serif text-primary">Waterproofing</span>
                    <h3 class="heading-92913 text-black text-center">Epoxy Grouting Work Services . . .</h3>
                </div>

                <p>Discover the strength and precision of Epoxy Grouting Work with Dhruvi Creation and
                    Waterproofing. Our specialized services are designed to provide durable solutions for various
                    applications,
                    ensuring stability, longevity, and aesthetic appeal. Explore the excellence of epoxy grouting with our
                    expert
                    team.</p>

                <div class="py-5">
                    <div class="container">
                        <h4 class="heading-92913 text-dark">Our Epoxy Grouting Services :</h4>
                        <p class="fw-bold">At Dhruvi Creation and Waterproofing, we offer a range of epoxy grouting
                            services, including:
                        </p>
                        <div class="row">
                            ...
                            <div class="col-md-4 service-29283">
                                ...
                                <p>Structural Stability: Strengthen and stabilize structures with precision epoxy grouting,
                                    preventing voids and
                                    ensuring a solid foundation.</p>
                            </div>
                            <div class="col-md-4 service-29283">
                                <span class="wrap-icon-39293">
                                    <img src="{{ url('frontend/images/tr3.jpeg') }}" alt="">
                                ...
                                <p>Our expert team applies epoxy grout with precision, whether it's for machinery bases,
                                    anchor bolts, or other critical structural elements.
                                </p>
                            </div>
                            <div class="service-29283 col-md-4">
                                <span class="wrap-icon-39293">
                                ...
                                <p>Enhance the appearance of surfaces with epoxy grouting that not only provides
                                    stability but also adds to the visual appeal.
                                </p>
                            </div>

                        </div>
                        <h4 class="heading-92913 text-dark my-5">Key Features of Our Epoxy Grouting Work :</h4>
                        <div class="row">
                            ...
                            <div class="col-md-4 service-29283">
                                ...
                                <h3>Durability :</h3>
                                <p>Benefit from the durability of epoxy grout, known for its resistance to chemicals, water,
                                    and other
                            ...
                            <div class="col-md-4 service-29283">
                                ...
                                <h3>Versatility : </h3>
                                <p>Our epoxy grouting services are versatile, suitable for a wide range of applications in
                                    industrial,
                            ...
                            <div class="service-29283 col-md-4">
                                ...
                                <h3>Custom Solutions :</h3>
                                <p>Tailored solutions to address the specific needs and challenges presented by your
                                    project,
